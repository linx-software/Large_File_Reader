...
In this example you'll see that I actually write the batches into a temp file to read it again with TextFileRead because of the nice CSV parser that is included with this function.
